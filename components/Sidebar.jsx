        ...
        <div className="p-4">
          <ul className="space-y-1">
            ...
            <Link
              href="/notes"
              className={`flex items-center bg-white hover:bg-yellow-100 rounded-xl font-bold text-sm ${
                isTagActive('Notes') ? 'bg-yellow-200 text-yellow-900 hover:bg-yellow-200' : 'text-gray-900'
              } py-3 px-4 cursor-pointer`}
              onClick={() => handleTagClick('Notes')}
            >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
                  height="1em"
                  fill="currentColor"
                  className={`text-lg mr-4 ${isTagActive('Notes') ? 'animate-pulse' : ''} `}
                  viewBox="0 0 16 16"
                >
            ...
            <Link
              href="/files"
              className={`flex items-center bg-white hover:bg-yellow-100 rounded-xl font-bold text-sm ${
                isTagActive('FileManager') ? 'bg-yellow-200 text-yellow-900 hover:bg-yellow-200' : 'text-gray-900'
              } py-3 px-4 cursor-pointer`}
              onClick={() => handleTagClick('FileManager')}
            >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
                  height="1em"
                  fill="currentColor"
                  className={`text-lg mr-4 ${isTagActive('FileManager') ? 'animate-pulse' : ''} `}
                  viewBox="0 0 16 16"
                >
